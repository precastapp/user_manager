...
class UserManagerServiceSuperToken implements UserManagerService {
  @override
  User? current;
  void Function(dynamic) openPageWeb;
  oauth2.Client? _client;
  final baseUrl =
      'https://6208a8b1428d11ed93ac8ba980aae9d4-us-east-1.aws.supertokens.io:3573';
  ...
  UserManagerServiceSuperToken(this.openPageWeb);
  ...
  Future<oauth2.Client?> createClient({bool byStorageOnly = false}) async {
    ...
    final identifier = 'HY-QlDc8CfxurZ9NYvr5H54xx=TX36';
    final redirectUrl =
    ...
    if (!byStorageOnly && _client == null) {
      ...
      parametres['audience'] = 'https://bussinessaccount.realiza.tech';
